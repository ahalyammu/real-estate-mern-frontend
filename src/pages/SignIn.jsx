    ...
    <div class="w-1/2 border rounded p-5 shadow-lg">
      <div class="flex flex-wrap items-center">
        <div class="w-full lg:w-1/2">
          <img class="w-full h-96" src="https://img.freepik.com/free-vector/tablet-login-concept-illustration_114360-7863.jpg" alt="" />
        </div>
        <div class="w-full lg:w-1/2">
          ...
          <button disabled={loading} className='bg-red-600 text-white p-3 rounded-lg uppercase hover:opacity-90 disabled:opacity-80 disabled:bg-slate-700 ms-2'>{loading ? 'Loading...' : 'Sign In'}</button>
          <OAuth/>
          </form>
