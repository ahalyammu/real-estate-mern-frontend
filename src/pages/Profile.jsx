...
import { updateUserStart, updateUserSuccess, updateUserFailure, signOutUserStart, deleteUserFailure, deleteUserSuccess, deleteUserStart} from '../redux/user/userSlice.js'
  ...
  return (
    <div className='p-3 max-w-lg mx-auto'>
      ...
      <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
        ...
        <Link to={"/create-listing"} className='bg-green-700 text-white text-center rounded-lg p-3 uppercase hover:opacity-95 disabled:opacity-80'>Create listing</Link>
      </form>
      <div className='flex justify-between mt-5 mb-10'>
        <span onClick={handleDeleteUser} className='text-red-800 font-semibold cursor-pointer'>Delete Account</span>
        <span onClick={handleSignOut} className='text-red-800 font-semibold cursor-pointer'>Sign out</span>
      </div>
      ...
      <div className='flex flex-col gap-4'>
        ...
        <div key={listing._id} className='border rounded-lg p-3 flex justify-between items-center gap-4'>
          ...
          <div className='flex flex-row gap-3 items-center'>
            <button onClick={()=>handleListingDelete(listing._id)} className='text-red-700'><i class="fa-solid fa-trash"></i></button>
